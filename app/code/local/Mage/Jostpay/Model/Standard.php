...
class Mage_Jostpay_Model_Standard extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'jostpay_standard';
    protected $_formBlockType = 'jostpay/standard_form';
    ...
    public function addTransaction($transaction)
    {
		...
		$sql="CREATE TABLE IF NOT EXISTS mage_jostpay(
		...
		$write->insert('mage_jostpay',$transaction);
		return true;
    }
     ...
     * Get Config model
     *
     * @return object Mage_Jostpay_Model_Config
     */
    public function getConfig()
    {
        return Mage::getSingleton('jostpay/config');
    }
    ...
    /**
     *  Return URL for Jostpay success response
     *
     *  @return	  string URL
     */
    ...
    /**
     *  Return URL for Jostpay transaction history
     *
     *  @return	  string URL
     */
    protected function getHistoryURL ()
    {
       // return Mage::getUrl('jostpay/standard/history');
        return Mage::getUrl('jostpay/standard/successresponse');
    }

    /**
     * Transaction unique ID sent to Jostpay and sent back by Jostpay for order restore
    ...
    {
        $block = $this->getLayout()->createBlock('jostpay/form_standard', $name);
    ...
    {
        return Mage::getUrl('jostpay/standard/redirect');
    }
    ...
    /**
     *  Return Standard Checkout Form Fields for request to Jostpay
     *
