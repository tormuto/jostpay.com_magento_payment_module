...
class Mage_Jostpay_Model_Config extends Varien_Object
{
    ...
    {
        if (!$this->hasData($key)) {
             $value = Mage::getStoreConfig('payment/jostpay_standard/'.$key);
    ...
    /**
     *  Return Store description sent to Jostpay
     *
    ...
    /**
     *  Return Jostpay registered merchant account name
     *
